...
export interface EncoderDecoderWidgetProps {
  caption?: string;
}

/** Deterministic, keyboard-friendly concept widget (no network, no persistence). */
export function EncoderDecoderWidget({ caption = "Encoder-Decoder" }: EncoderDecoderWidgetProps): JSX.Element {
  return (
    <figure class="concept-widget" aria-label={caption}>
      ...
      <div class="concept-widget__body">
        <p>encoder 표현을 decoder cross-attention이 조회합니다.</p>
        <ol>
...
export default EncoderDecoderWidget;
