...
export interface ScaledDotProductWidgetProps {
  caption?: string;
}

/** Deterministic, keyboard-friendly concept widget (no network, no persistence). */
export function ScaledDotProductWidget({ caption = "Scaled Dot-Product" }: ScaledDotProductWidgetProps): JSX.Element {
  return (
    <figure class="concept-widget" aria-label={caption}>
      ...
      <div class="concept-widget__body">
        <p>QK^T를 scale로 나눈 뒤 softmax로 가중치를 만듭니다.</p>
        <ol>
...
export default ScaledDotProductWidget;
