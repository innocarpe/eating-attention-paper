...
export interface MaskingWidgetProps {
  caption?: string;
}

/** Deterministic, keyboard-friendly concept widget (no network, no persistence). */
export function MaskingWidget({ caption = "마스킹" }: MaskingWidgetProps): JSX.Element {
  return (
    <figure class="concept-widget" aria-label={caption}>
      ...
      <div class="concept-widget__body">
        <p>미래 위치나 패딩 위치의 점수를 가려 무효화합니다.</p>
        <ol>
