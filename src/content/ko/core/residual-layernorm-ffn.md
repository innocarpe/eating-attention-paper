...
서브층 주변 연결과 position-wise FFN을 다룬다.
...
## 활동
1. `act.core.residual.concept`
1. `act.core.residual.math`
1. `act.core.residual.impl`
1. `act.core.residual.explain`
