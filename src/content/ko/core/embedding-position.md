...
## 활동
1. `act.core.embedding-position.concept`
1. `act.core.embedding-position.math`
1. `act.core.embedding-position.impl`
1. `act.core.embedding-position.explain`
