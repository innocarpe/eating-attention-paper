...
label smoothing과 학습 스케줄 선택을 선택적으로 깊게 읽는다.

## 영어 기술 용어
label smoothing, learning rate schedule
...
## 활동
1. `act.deep.training-objective.concept`
1. `act.deep.training-objective.check`
